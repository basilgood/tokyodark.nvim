...
hl.common = {
    ...
    DiffAdd = {fg = p.fg, bg = p.diff_green},
    DiffChange = {fg = p.fg, bg = p.diff_blue},
    DiffDelete = {fg = p.diff_red, bg = p.diff_red},
    DiffText = {fg = p.yellow, gb = p.bg5},
    diffAdded = {fg = p.green},
    diffRemoved = {fg = p.red},
    diffSubname = {fg = p.yellow, bg = p.bg5},
    diffLine = {bg = p.bg5},
